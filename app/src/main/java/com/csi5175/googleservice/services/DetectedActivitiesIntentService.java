 ...
 * Yan Zhang
 * 300052103
 * This class is for intent service and retrieve results from intent of google services
 * */
...
/*
 * handles the returned result from activity recognition and transition
 * */
public class DetectedActivitiesIntentService extends IntentService {
    ...
    /*
     * receive and extract result from intent,
     *then call broadcast to handle each detected activity
     * */
    @Override
    protected void onHandleIntent(@Nullable Intent intent) {
        if (ActivityTransitionResult.hasResult(intent)) {//returned is activity transition
        ...
        } else if (ActivityRecognitionResult.hasResult(intent)) {//returned is activity recognition
